...
> For a quick-start experience without building from source, see the **Quick Start (Distribution)** section in `Deployement.md`.
...
- [WSO2 REST API Design Guidelines](https://wso2.com/whitepapers/wso2-rest-apis-design-guidelines/)
- [WSO2 Secure Coding Guidelines](https://security.docs.wso2.com/en/latest/security-guidelines/secure-engineering-guidelines/secure-coding-guidlines/general-recommendations-for-secure-coding/)
